    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:800px;height:350px;overflow:hidden;visibility:hidden;background-color:#24262e;">
        <!-- Loading Screen -->
        <div data-u="loading" style="position:absolute;top:0px;left:0px;background-color:rgba(0,0,0,0.7);">
            <div style="filter: alpha(opacity=70); opacity: 0.7; position: absolute; display: block; top: 0px; left: 0px; width: 100%; height: 100%;"></div>
            <div style="position:absolute;display:block;background:url('Images/loading.gif') no-repeat center center;top:0px;left:0px;width:100%;height:100%;"></div>
        </div>
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:800px;height:253px;overflow:hidden;">
        ...
        <?php include('config.php');
         ...
         <?php while ($dong = mysqli_fetch_array($run, MYSQLI_ASSOC)) {
            ...
            <div>
               <a href="#">
<img data-u="image" src="Images/<?php echo $dong['hinh'] ?>">                          
            </div>
            ...
            <div>
            <a href="#"> <img data-u="image" src="Images/12.jpg" />
                <img data-u="thumb" src="Images/thumb-12.jpg" /></a>
            </div>
        </div>
        <!-- Thumbnail Navigator -->
